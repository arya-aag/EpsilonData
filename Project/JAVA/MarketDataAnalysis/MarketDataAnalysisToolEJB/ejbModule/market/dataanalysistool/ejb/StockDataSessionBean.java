...
/**
 * Session Bean implementation class StockDataSessionBean
 */
@Stateless
@Remote(StockDataRemote.class)
@Local(StockDataLocal.class)
public class StockDataSessionBean implements StockDataRemote, StockDataLocal {
